...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FreelancerManager\\ConfigurationController' => 'getConfigurationControllerService',
            'App\\Controller\\FreelancerManager\\CustomerController' => 'getCustomerControllerService',
            'App\\Controller\\FreelancerManager\\IndexController' => 'getIndexControllerService',
            'App\\Controller\\FreelancerManager\\InvoicesController' => 'getInvoicesControllerService',
            'App\\Controller\\FreelancerManager\\PDFController' => 'getPDFControllerService',
            'App\\Controller\\FreelancerManager\\ProjectsController' => 'getProjectsControllerService',
            'App\\Controller\\FreelancerManager\\ReportingController' => 'getReportingControllerService',
            'App\\Controller\\FreelancerManager\\ServicesController' => 'getServicesControllerService',
            'App\\Controller\\FreelancerManager\\TimeTrackingController' => 'getTimeTrackingControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\IndexController' => 'getIndexController2Service',
            'App\\Controller\\KontoManager\\BankController' => 'getBankControllerService',
            'App\\Controller\\KontoManager\\CategoryController' => 'getCategoryControllerService',
            'App\\Controller\\KontoManager\\CsvImportController' => 'getCsvImportControllerService',
            'App\\Controller\\KontoManager\\ImportFilterController' => 'getImportFilterControllerService',
            'App\\Controller\\KontoManager\\IndexController' => 'getIndexController3Service',
            'App\\Controller\\KontoManager\\OverviewController' => 'getOverviewControllerService',
            'App\\Controller\\KontoManager\\ReportingController' => 'getReportingController2Service',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Logger/UserEmailProcessor.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lw8Py-LYty', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ELE3ZRIaYo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g5Ox8H+--i', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DhkXRVDNoz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AccountBankAccountsRepository' => ['privates', 'App\\Repository\\AccountBankAccountsRepository', 'getAccountBankAccountsRepositoryService', true],
            'App\\Repository\\AccountCategoriesRepository' => ['privates', 'App\\Repository\\AccountCategoriesRepository', 'getAccountCategoriesRepositoryService', true],
            'App\\Repository\\AccountDataRepository' => ['privates', 'App\\Repository\\AccountDataRepository', 'getAccountDataRepositoryService', true],
            'App\\Repository\\AccountImportFilterRepository' => ['privates', 'App\\Repository\\AccountImportFilterRepository', 'getAccountImportFilterRepositoryService', true],
            'App\\Repository\\AppConfigRepository' => ['privates', 'App\\Repository\\AppConfigRepository', 'getAppConfigRepositoryService', true],
            'App\\Repository\\FlConfigurationRepository' => ['privates', 'App\\Repository\\FlConfigurationRepository', 'getFlConfigurationRepositoryService', true],
            'App\\Repository\\FlCustomerRepository' => ['privates', 'App\\Repository\\FlCustomerRepository', 'getFlCustomerRepositoryService', true],
            'App\\Repository\\FlInvoicesRepository' => ['privates', 'App\\Repository\\FlInvoicesRepository', 'getFlInvoicesRepositoryService', true],
            'App\\Repository\\FlProjectEntriesRepository' => ['privates', 'App\\Repository\\FlProjectEntriesRepository', 'getFlProjectEntriesRepositoryService', true],
            'App\\Repository\\FlProjectsRepository' => ['privates', 'App\\Repository\\FlProjectsRepository', 'getFlProjectsRepositoryService', true],
            'App\\Repository\\FlServiceContractEntriesRepository' => ['privates', 'App\\Repository\\FlServiceContractEntriesRepository', 'getFlServiceContractEntriesRepositoryService', true],
            'App\\Repository\\FlServiceContractsRepository' => ['privates', 'App\\Repository\\FlServiceContractsRepository', 'getFlServiceContractsRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\AccountBankAccountsRepository' => '?',
            'App\\Repository\\AccountCategoriesRepository' => '?',
            'App\\Repository\\AccountDataRepository' => '?',
            'App\\Repository\\AccountImportFilterRepository' => '?',
            'App\\Repository\\AppConfigRepository' => '?',
            'App\\Repository\\FlConfigurationRepository' => '?',
            'App\\Repository\\FlCustomerRepository' => '?',
            'App\\Repository\\FlInvoicesRepository' => '?',
            'App\\Repository\\FlProjectEntriesRepository' => '?',
            'App\\Repository\\FlProjectsRepository' => '?',
            'App\\Repository\\FlServiceContractEntriesRepository' => '?',
            'App\\Repository\\FlServiceContractsRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\BlogController', 'App\\Controller\\DashboardController', 'App\\Controller\\DefaultController', 'App\\Controller\\FreelancerManager\\ConfigurationController', 'App\\Controller\\FreelancerManager\\CustomerController', 'App\\Controller\\FreelancerManager\\IndexController', 'App\\Controller\\FreelancerManager\\InvoicesController', 'App\\Controller\\FreelancerManager\\PDFController', 'App\\Controller\\FreelancerManager\\ProjectsController', 'App\\Controller\\FreelancerManager\\ReportingController', 'App\\Controller\\FreelancerManager\\ServicesController', 'App\\Controller\\FreelancerManager\\TimeTrackingController', 'App\\Controller\\HomeController', 'App\\Controller\\IndexController', 'App\\Controller\\KontoManager\\BankController', 'App\\Controller\\KontoManager\\CategoryController', 'App\\Controller\\KontoManager\\CsvImportController', 'App\\Controller\\KontoManager\\ImportFilterController', 'App\\Controller\\KontoManager\\IndexController', 'App\\Controller\\KontoManager\\OverviewController', 'App\\Controller\\KontoManager\\ReportingController', 'App\\Controller\\PortfolioController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0mnCekYkpO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Jc1AzbtHAQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9wuPYby0IY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+YNkRodHA5', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x+bZG8tNdq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-ikTX8fX4n', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $c), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($c), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($d, $e, $f, $g, NULL)), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($d, $e, $a, $f, $g, NULL), $b)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b)]), $b);
    }
    ...
    protected static function getLocaleAwareListenerService($container)
    {
        return $container->privates['locale_aware_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleAwareListener(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('de'));
    ...
    {
        return $container->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'de', ($container->services['router'] ?? self::getRouterService($container)), false, []);
    }
     ...
     */
    protected static function getMonolog_Handler_AppService($container)
    {
        $container->privates['monolog.handler.app'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/app.log'), 'debug', true, NULL, false);
    ...
    protected static function getMonolog_LoggerService($container)
    {
        ...
        $instance->pushHandler(($container->privates['monolog.handler.app'] ?? self::getMonolog_Handler_AppService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.console'] ?? self::getMonolog_Handler_ConsoleService($container)));
        $instance->pushProcessor(new \App\Logger\UserEmailProcessor(($container->privates['security.helper'] ?? self::getSecurity_HelperService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack())));
    ...
    protected static function getSecurity_HelperService($container)
    {
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Security\\GenuisProAuthenticator' => ['privates', 'App\\Security\\GenuisProAuthenticator', 'getGenuisProAuthenticatorService', true],
            ...
            'App\\Security\\GenuisProAuthenticator' => '?',
    ...
    {
        return $container->privates['translation.locale_switcher'] = new \Symfony\Component\Translation\LocaleSwitcher('de', new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('de'));
            yield 1 => ($container->privates['translator.default'] ?? self::getTranslator_DefaultService($container));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addGlobal('APP_LOGIN_LOGO', $container->getEnv('resolve:LOGIN_LOGO'));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'APP_LOGIN_LOGO' => $container->getEnv('resolve:LOGIN_LOGO'),
