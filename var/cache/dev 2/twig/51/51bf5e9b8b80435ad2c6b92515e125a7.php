...
class __TwigTemplate_7e49c129eb8faa21da196be9177676b8 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"col\">
    ...
    <button type=\"button\" class=\"btn btn-outline-primary mb-1\" onclick=\"window.location.href='";
        ...
        echo "'\">Neue Kategorie</button>
    <p>Kategorien definiert: <strong>";
        // line 7
        ...
        echo "</strong> | Einträge ohne Kategorie: <strong>";
