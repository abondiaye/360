...
$context["e"], "record_type", [], "any", false, false, false, 12) == twig_constant("App\\Entity\\FlProjectEntries::RT_TRAVEL_ALLOWANCE"))) {
  ...
  <td width=\"363\">";
            // line 16
            if ((twig_get_attribute($this->env, $this->source, $context["e"], "record_type", [], "any", false, false, false, 16) == twig_constant("App\\Entity\\FlProjectEntries::RT_TRAVEL_ALLOWANCE"))) {
                echo "Fahrkostenpauschale";
                if ((twig_get_attribute($this->env, $this->source, $context["e"], "work_description", [], "any", false, false, false, 16) != "")) {
                    echo "<br>";
                }
            }
            echo twig_nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["e"], "work_description", [], "any", false, false, false, 16), "html", null, true));
            echo "</td>
</tr>
";
            ++$context['loop']['index0'];
  ...
  <td style=\"text-align:center;border-top: 1px solid #666666;\"><b>";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Twig\AppRuntime')->formatWorkTime((isset($context["TOTAL_SECONDS"]) || array_key_exists("TOTAL_SECONDS", $context) ? $context["TOTAL_SECONDS"] : (function () { throw new RuntimeError('Variable "TOTAL_SECONDS" does not exist.', 21, $this->source); })())), "html", null, true);
        echo "</b></td>
  <td style=\"border-top: 1px solid #666666;\"><b>";
        // line 22
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency((isset($context["TOTAL_SALARY"]) || array_key_exists("TOTAL_SALARY", $context) ? $context["TOTAL_SALARY"] : (function () { throw new RuntimeError('Variable "TOTAL_SALARY" does not exist.', 22, $this->source); })()), "EUR"), "html", null, true);
        echo "</b></td>
</tr>
</table>
";
    ...
    {
        return array (  132 => 22,  128 => 21,  124 => 19,  101 => 16,  98 => 15,  92 => 13,  90 => 12,  85 => 11,  83 => 10,  78 => 8,  69 => 7,  52 => 6,  47 => 4,  43 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("{# Output of entries for a given project - note that this HTML code is specific to tcpdf !!#}
