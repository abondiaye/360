...
class __TwigTemplate_5f315913339aa515ff71c9e8cb955c56 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-xl-3 col-lg-4 col-md-4 col-6\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          <div class=\"card-title h3\">Aperçu de la Base de Données</div>
        ...
        echo "</td>
          ...
          <tr>
            ...
            <td>";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatNumber(twig_get_attribute($this->env, $this->source, (isset($context["TOTAL_STATS"]) || array_key_exists("TOTAL_STATS", $context) ? $context["TOTAL_STATS"] : (function () { throw new RuntimeError('Variable "TOTAL_STATS" does not exist.', 20, $this->source); })()), "TOTAL_CATEGORIES", [], "array", false, false, false, 20), array(), "decimal", "default", "fr"), "html", null, true);
        echo " </td>
          </tr>
          <tr>
            <td>Nombre de filtres d'import :</td>
            <td>";
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatNumber(twig_get_attribute($this->env, $this->source, (isset($context["TOTAL_STATS"]) || array_key_exists("TOTAL_STATS", $context) ? $context["TOTAL_STATS"] : (function () { throw new RuntimeError('Variable "TOTAL_STATS" does not exist.', 24, $this->source); })()), "TOTAL_FILTER", [], "array", false, false, false, 24), array(), "decimal", "default", "fr"), "html", null, true);
        echo " </td>
          </tr>
          </tbody>
          </table>
    ...
    <div class=\"col-xl-3 col-lg-4 col-md-4 col-6\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          <div class=\"card-title h3\">Revenus ";
        // line 34
        ...
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, (isset($context["YEAR_STATS"]) || array_key_exists("YEAR_STATS", $context) ? $context["YEAR_STATS"] : (function () { throw new RuntimeError('Variable "YEAR_STATS" does not exist.', 39, $this->source); })()), "INCOME", [], "array", false, false, false, 39), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
              <td>Dépenses :</td>
        ...
        // line 43
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, (isset($context["YEAR_STATS"]) || array_key_exists("YEAR_STATS", $context) ? $context["YEAR_STATS"] : (function () { throw new RuntimeError('Variable "YEAR_STATS" does not exist.', 43, $this->source); })()), "OUTCOME", [], "array", false, false, false, 43), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
              <td>Différence :</td>
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, (isset($context["YEAR_STATS"]) || array_key_exists("YEAR_STATS", $context) ? $context["YEAR_STATS"] : (function () { throw new RuntimeError('Variable "YEAR_STATS" does not exist.', 47, $this->source); })()), "DIFFERENCE", [], "array", false, false, false, 47), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            ";
        // line 49
    ...
    <div class=\"col-xl-3 col-lg-4 col-md-4 col-6\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          <div class=\"card-title h3\">Revenus Totaux</div>
          <table class=\"table table-sm\">
            <tbody>
            <tr>
              <td>Revenus :</td>
        ...
        echo "</td>
            ...
            <tr>
              ...
              <td class=\"text-end text-danger\">";
        // line 72
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, (isset($context["ALLTIME_STATS"]) || array_key_exists("ALLTIME_STATS", $context) ? $context["ALLTIME_STATS"] : (function () { throw new RuntimeError('Variable "ALLTIME_STATS" does not exist.', 72, $this->source); })()), "OUTCOME", [], "array", false, false, false, 72), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
              <td>Différence :</td>
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, (isset($context["ALLTIME_STATS"]) || array_key_exists("ALLTIME_STATS", $context) ? $context["ALLTIME_STATS"] : (function () { throw new RuntimeError('Variable "ALLTIME_STATS" does not exist.', 76, $this->source); })()), "DIFFERENCE", [], "array", false, false, false, 76), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
              <td>Revenus salariaux uniquement :</td>
              <td class=\"text-end text-success\">";
        // line 80
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency((isset($context["TOTAL_GEHALT"]) || array_key_exists("TOTAL_GEHALT", $context) ? $context["TOTAL_GEHALT"] : (function () { throw new RuntimeError('Variable "TOTAL_GEHALT" does not exist.', 80, $this->source); })()), "EUR", array(), "fr"), "html", null, true);
        echo "</td>
            </tr>
            </tbody>
          </table>
  ...
  <div class=\"row mt-3\">
    <div class=\"col-12\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          <div class=\"card-title h3 text-center\">Évolution du Salaire Net</div>
  ...
  \$(document).ready(function() {
    ...
    const myChart = new Chart(ctx, {
      ...
      data: {
        labels: labels,
        datasets: [{
          label: 'Salaire net annuel en EUR',
          data: values,
  ...
  <div class=\"row\">
    <div class=\"col-xl-3 col-lg-4 col-md-4 col-6\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          ...
          <tr>
            <td>Nombre d'enregistrements :</td>
            <td>{{TOTAL_STATS['TOTAL_ROWS']|format_number(locale='fr')}} </td>
          </tr>
          <tr>
            <td>Période :</td>
          ...
          <tr>
            <td>Nombre de catégories :</td>
            <td>{{TOTAL_STATS['TOTAL_CATEGORIES']|format_number(locale='fr')}} </td>
          </tr>
          <tr>
            <td>Nombre de filtres d'import :</td>
            <td>{{TOTAL_STATS['TOTAL_FILTER']|format_number(locale='fr')}} </td>
          </tr>
          </tbody>
          </table>
        </div>
    ...
    <div class=\"col-xl-3 col-lg-4 col-md-4 col-6\">
      <div class=\"card h-100\">
        <div class=\"card-body\">
          <div class=\"card-title h3\">Revenus {{ YEAR }}</div>
          <table class=\"table table-sm\">
            <tbody>
            <tr>
              <td>Revenus :</td>
              <td class=\"text-end text-success\">{{YEAR_STATS['INCOME']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            <tr>
              <td>Dépenses :</td>
              <td class=\"text-end text-danger\">{{ YEAR_STATS['OUTCOME']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            <tr>
              <td>Différence :</td>
              <td class=\"text-end {{ YEAR_STATS['DIFFERENCE']|MoneyColor }}\">{{ YEAR_STATS['DIFFERENCE']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            {% if BALANCE_STATS['balance'] is defined %}
            <tr>
              <td>Solde au {{ BALANCE_STATS['balance_date']|date('d.m.Y') }} :</td>
              <td class=\"text-end {{ BALANCE_STATS['balance']|MoneyColor }}\">{{ BALANCE_STATS['balance']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            {% endif %}
            </tbody>
          </table>
      ...
      <div class=\"card h-100\">
        <div class=\"card-body\">
          ...
          <table class=\"table table-sm\">
            ...
            <tr>
              <td>Revenus :</td>
              <td class=\"text-end text-success\">{{ALLTIME_STATS['INCOME']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            <tr>
              <td>Dépenses :</td>
              <td class=\"text-end text-danger\">{{ ALLTIME_STATS['OUTCOME']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            <tr>
              <td>Différence :</td>
              <td class=\"text-end {{ ALLTIME_STATS['DIFFERENCE']|MoneyColor }}\">{{ ALLTIME_STATS['DIFFERENCE']|format_currency('EUR',locale='fr')}}</td>
            </tr>
            <tr>
              <td>Revenus salariaux uniquement :</td>
              <td class=\"text-end text-success\">{{ TOTAL_GEHALT|format_currency('EUR',locale='fr')}}</td>
            </tr>
            </tbody>
          </table>
        </div>
